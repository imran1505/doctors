...
<body>
	...
	<div id="signInContainer">
		<form name="signUpForm" id="signUpForm" action="Controller?action=changePassword" method="post">
			<div style="padding: 10px 10px 0 10px;">
				<span style="padding: 10px 10px 0 10px;">Please enter your new password.</span>
				<div style="padding: 10px">
					<input type="password" name="oldpwd" id="oldpwd" class="textBoxBig" placeholder="Current Password">
				</div>
				<div style="padding: 10px">
					<input type="password" name="pwd" id="pwd" class="textBoxBig" placeholder="New password">
				</div>
				<div style="padding: 10px">
...
$(document).ready(function() {
  ...
  $('#signUpForm').submit(function(event) {
    ...
    $.ajax({
    	url: $("#signUpForm").attr( "action")+"&pwd="+pwd+"&oldpwd="+oldpwd,
       	type: "POST",
