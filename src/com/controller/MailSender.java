...
public class MailSender {
	final static String senderEmailID = " contactbackupnotifier@gmail.com";
	final static String senderPassword = "welldone";
	...
	final static String emailSubject ="Contact Backup password reovery";
